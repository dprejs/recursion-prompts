...
var arraySum = function(array) {
  ...
  if (Array.isArray(array[0])){
    return parseInt(arraySum(array[0])) + parseInt(arraySum(array.slice(1)));
  }
  if (array.length === 1){
    return array[0];
  }

  return parseInt(array[0]) + parseInt(arraySum(array.slice(1)));
};
...
var range = function(x, y) {
  ...
  return [x+1, range(x+1, y)].flat(Infinity);
  }
  if(x>y) {
    if (x <= y+1) {
      return [];
...
var createArray = function(str) {
  ...
  return [str[0], createArray(str.slice(1))].flat(Infinity);
};
...
var reverseArr = function(array) {
  ...
  return [array[array.length-1], reverseArr(array.slice(0,-1))].flat(Infinity);
};
...
var buildList = function(value, length) {
  if (value !== undefined && value.length === 0) {
    ...
    return [[value], buildList(value, length-1)].flat(1);
  }
  if (length === 1) {
    return [value];
  }
  return [[value], buildList(value, length-1).flat(1)].flat(1);
};
...
var fizzBuzz = function(n) {
  ...
  if (n % 3 === 0 && n % 5 === 0) {
    return [fizzBuzz(n-1).flat(1), 'FizzBuzz'].flat(1);
  }
  if (n % 3 === 0) {
    return [fizzBuzz(n-1).flat(1), 'Fizz'].flat(1);
  }
  if (n % 5 === 0) {
    return [fizzBuzz(n-1).flat(1), 'Buzz'].flat(1);
  }
  return [fizzBuzz(n-1).flat(1), n.toString()].flat(1);
};
...
var rMap = function(array, callback) {
  ...
  return [callback(array[0]), rMap(array.slice(1), callback)].flat(1);
};
